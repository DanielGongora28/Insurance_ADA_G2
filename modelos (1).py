...
df=pd.read_csv("Preprocesamiento_Finanzas1.csv")
...
minmax_cols=['Infec_Paras', 'tumors', 'neu_sys_issues', 'eye_iss',
       ...
       'traumas_poison_ext_causes', 'health_feat']
scaler=MinMaxScaler()
...
X_train, X_test, y_train, y_test = train_test_split(grouped, y, test_size=0.3, random_state=42)
